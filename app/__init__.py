...
from .api import user_routes, auth_routes, bible_routes,note_routes, task_routes, plan_routes, bookmark_routes, highlight_routes
...
app.register_blueprint(highlight_routes, url_prefix='/api/highlights')
db.init_app(app)
Migrate(app, db)
