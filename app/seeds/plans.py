...
def seed_plans():
    ...
    plan_template1 = Plan(
        ...
        template_id=None,
        start_date=None,
        image_url='https://the-word-bucket.s3.amazonaws.com/brett-jordan-E1por_SGvJE-unsplash.jpg',
    ...
    plan_template2 = Plan(
        ...
        template_id=None,
        start_date=None,
        image_url='https://the-word-bucket.s3.amazonaws.com/yannick-pulver-FAU2NI1Uixg-unsplash.jpg',
        enrolled_user_id=None,
        tasks=tasks30
    )
